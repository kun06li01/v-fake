    ...
    <div class="seller-content">
      ...
      <div class="bulletin">
        ...
        <ul v-if="seller.supports" class="supports">
          <li border-1px class="support-item" v-for="item in seller.supports">
      ...
      <div class="pics">
        ...
        <div class="pic-wrapper" ref="picScrollRef">
      ...
      <div class="info">
        ...
        <ul>
          <li border-1px class="info-item" v-for="info in seller.infos">
            {{info}}
          </li>
        </ul>
      </div>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    data() {
      return {
        favourite: (() => {
          return loadLocal(this.seller.id, 'favourite', false);
        })()
      };
    },
    computed: {
    ...
    methods: {
      ...
      toggleFavourite(event) {
        ...
        saveLocal(this.seller.id, 'favourite', this.favourite);
      }
    },
    components: {
      star,
